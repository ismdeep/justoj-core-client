#ifndef JUSTOJ_OKCALSS
#define JUSTOJ_OKCALSS
/*
 *
 *
...
int LANG_YV[256] = {0, 39, 99, 302, 99, 32, 72, 131, 1, 2, 3, 4, 5, 6, 8, 9, 10, 11, 12, 13, 14, 16, 21, 59, 78, 79, 89,
                    97, 102, 104, 107, 108, 158, 202, 218, 228, 231, 257, 273, 41, 42, 146, SYS_mremap, 158, 117, 60,
                    39,
                    102, 191, 318, 234,
...
//scheme
int LANG_SV[256] = {0, 39, 157, 302, 1, 2, 3, 4, 5, 8, 9, 10, 11, 12, 13, 14, 16, 21, 24, 28, 32, 41, 42, 56, 59, 63,
                    72, 78,
                    79, 89, 97, 102, 131, 137, 158, 202, 204, 218, 229, 231, 234, 257, 273, 257, 141, 95, 64, 65, 66,
                    83, 24, 42, 41, 158, 117, 60, 290, 291, 293,
                    39, 102, 191, SYS_access, SYS_brk, SYS_chmod, SYS_clock_getres,
                    SYS_clock_gettime, SYS_clone, SYS_close, SYS_execve, SYS_exit_group,
                    SYS_fcntl, SYS_fstat, SYS_ftruncate, SYS_futex, SYS_getcwd,
                    SYS_getdents, SYS_geteuid, SYS_getpid, SYS_getppid, SYS_getrlimit,
...
//sbcl
int LANG_SBCLV[256] = {0, 39, 157, 302, 1, 2, 3, 4, 5, 8, 9, 10, 11, 12, 13, 14, 16, 21, 24, 27, 28, 32, 41, 42, 56, 59, 62, 63,
                       72, 78, 79, 89, 97, 102, 131, 137, 158, 202, 204, 218, 229, 231, 234, 257, 273, 257, 141, 95, 64,
                       65, 66, 83, 24, 42, 41, 158, 117, 60, 290, 291, 293, 39, 102, 191, SYS_access, SYS_brk,
                       SYS_chmod, SYS_clock_getres,
                       SYS_clock_gettime, SYS_clone, SYS_close, SYS_execve, SYS_exit_group,
                       SYS_fcntl, SYS_fstat, SYS_ftruncate, SYS_futex, SYS_getcwd,
                       SYS_getdents, SYS_geteuid, SYS_getpid, SYS_getppid, SYS_getrlimit,
                       SYS_gettimeofday, SYS_getuid, SYS_ioctl, SYS_lseek, SYS_lstat, SYS_mmap,
